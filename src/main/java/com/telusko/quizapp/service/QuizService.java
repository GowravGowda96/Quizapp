...
public class QuizService {
    ...
    public ResponseEntity<String> createQuiz(String category, int numQ, String title) {
        ...
        quizDao.save(quiz);
        return new ResponseEntity<>("successfully quiz created", HttpStatus.OK);
    }

    public ResponseEntity<List<QuestionWrapper>> getListQuestion(Integer id) {
    ...
    public ResponseEntity<Integer> submitResponses(Integer id, List<Response> responses) {
